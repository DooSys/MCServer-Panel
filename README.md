...
```bash
docker build --build-arg APP_VERSION=1.1.10 -t ghcr.io/doosys/mcserver-panel:1.1.10 .
```
...
docker run --rm -p 8088:8080 \
  ...
  ghcr.io/doosys/mcserver-panel:1.1.10
```
...
- `ghcr.io/doosys/mcserver-panel:1.1.10` avec un tag Git `v1.1.10` ;
...
| `APP_VERSION` | `1.1.10` | Version affichee pour MCServer-Panel |
...
| `CATALOG_USER_AGENT` | `MCServer-Panel/1.1.10` | User-Agent envoye aux APIs externes |
