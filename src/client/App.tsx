...
function UsersPage({ language }: PageProps) { return <section className="panel page-panel"><h2>{t(language, 'usersRoles')}</h2><p>{t(language, 'usersText')}</p><a className="button-link" href="/_/" target="_blank">{t(language, 'openPocketBase')}</a></section>; }
