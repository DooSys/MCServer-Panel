...
const translations = {
  fr: {
    ...
    emailOrUser: 'Email ou utilisateur', password: 'Mot de passe', login: 'Connexion', loginFailed: 'Login impossible',
    ...
    controlledFiles: 'Fichiers controles', mcDataReadOnly: 'Lecture limitee a /mc-data', filter: 'Filtrer',
  ...
  en: {
    ...
    emailOrUser: 'Email or username', password: 'Password', login: 'Sign in', loginFailed: 'Unable to sign in',
    ...
    controlledFiles: 'Controlled files', mcDataReadOnly: 'Read access limited to /mc-data', filter: 'Filter',
