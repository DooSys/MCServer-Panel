...
const translations = {
  fr: {
    loading: 'Chargement du panel...', logout: 'Sortir', serverRuntime: 'Serveur itzg / Java', refresh: 'Rafraichir', players: 'joueurs',
    emailOrUser: 'Email ou utilisateur', password: 'Mot de passe', login: 'Connexion', loginFailed: 'Connexion impossible : verifie email et mot de passe',
    navDashboard: 'Dashboard', navConsole: 'Console', navPlayers: 'Joueurs', navRules: 'Regles', navAddons: 'Addons', navCatalog: 'Catalogue', navFiles: 'Fichiers', navLogs: 'Logs', navSettings: 'Serveur', navUsers: 'Roles',
    ...
    quickActions: 'Actions rapides', controlledRcon: 'Commandes RCON controlees', day: 'Jour', clearWeather: 'Meteo claire', serverMessage: 'Message serveur', send: 'Envoyer', actionDone: 'Action executee', error: 'Erreur',
    rconConsole: 'Console RCON', rconConsoleHint: 'Mot de passe masque, commandes limitees', commandRejected: 'Commande refusee',
    ...
    usersRoles: 'Utilisateurs et roles', usersText: "Les comptes, emails, SMTP et permissions sont geres par PocketBase. Les collections applicatives sont creees par le script d'initialisation.", openPocketBase: 'Ouvrir PocketBase', pbAdmin: 'PocketBase',
  ...
  en: {
    loading: 'Loading panel...', logout: 'Sign out', serverRuntime: 'itzg / Java server', refresh: 'Refresh', players: 'players',
    emailOrUser: 'Email or username', password: 'Password', login: 'Sign in', loginFailed: 'Unable to sign in: check email and password',
    navDashboard: 'Dashboard', navConsole: 'Console', navPlayers: 'Players', navRules: 'Rules', navAddons: 'Addons', navCatalog: 'Catalog', navFiles: 'Files', navLogs: 'Logs', navSettings: 'Server', navUsers: 'Roles',
    ...
    quickActions: 'Quick actions', controlledRcon: 'Controlled RCON commands', day: 'Day', clearWeather: 'Clear weather', serverMessage: 'Server message', send: 'Send', actionDone: 'Action executed', error: 'Error',
    rconConsole: 'RCON console', rconConsoleHint: 'Password hidden, commands restricted', commandRejected: 'Command rejected',
    ...
    connected: 'Connected', nickname: 'Nickname', add: 'Add', noItem: 'No item',
    addonsTitle: 'Addons and datapacks', uploadZip: 'Upload zip', datapackUnavailable: 'datapack list unavailable', datapackUploaded: 'Datapack uploaded', uploadRejected: 'Upload rejected', catalogTitle: 'Modrinth catalog', catalogHint: 'Filtered by detected server runtime and Minecraft version.', catalogSearch: 'Search a datapack, plugin or mod', allTypes: 'All compatible types', typeDatapack: 'Datapack', typePlugin: 'Plugin', typeMod: 'Mod', typeResourcepack: 'Resource pack', install: 'Install', installed: 'Installed', incompatible: 'Not installable', downloads: 'downloads', openSource: 'Open source', noResults: 'No result', catalogLoadError: 'Catalog unavailable', replaceAndInstall: 'Replace existing file?',
    controlledFiles: 'Controlled files', mcDataReadOnly: 'Read access limited to /mc-data', filter: 'Filter', logSource: 'Log source', live: 'Live', paused: 'Paused', pauseLive: 'Pause live refresh', resumeLive: 'Resume live refresh', followScroll: 'Auto-scroll', tailLines: 'Lines', lastUpdate: 'Updated', logUnavailable: 'Logs unavailable',
    ...
    usersRoles: 'Users and roles', usersText: 'Accounts, email, SMTP and permissions are managed by PocketBase. Application collections are created by the initialization script.', openPocketBase: 'Open PocketBase', pbAdmin: 'PocketBase',
