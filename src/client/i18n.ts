...
const translations = {
  fr: {
    ...
    worldRules: 'Regles du monde', rconRead: 'Lecture RCON...', apply: 'Appliquer', backRecommended: "Appliquer valeur conseillee", ruleApplied: 'regle appliquee', gameruleError: "Erreur gamerule", themeLight: "Mode clair", themeDark: "Mode sombre",
  ...
  en: {
    ...
    worldRules: 'World rules', rconRead: 'Reading RCON...', apply: 'Apply', backRecommended: "Apply recommended", ruleApplied: 'rule applied', gameruleError: "Gamerule error", themeLight: "Light mode", themeDark: "Dark mode",
