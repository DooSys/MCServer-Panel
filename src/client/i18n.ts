...
const translations = {
  fr: {
    loading: 'Chargement du panel...', logout: 'Déconnexion', serverRuntime: 'MCServer-panel', refresh: 'Actualiser', players: 'joueurs',
    emailOrUser: 'Email ou utilisateur', password: 'Mot de passe', login: 'Connexion', signingIn: 'Connexion...', loginFailed: 'Connexion impossible : vérifie email et mot de passe',
    navDashboard: 'Vue d\'ensemble', navConsole: 'Console', navPlayers: 'Joueurs', navRules: 'Règles', navAddons: 'Add-ons', navCatalog: 'Catalogue', navFiles: 'Fichiers', navLogs: 'Logs', navSettings: 'Config', navUsers: 'Accès',
    state: 'État', online: 'Online', offline: 'Offline', rconChecked: 'Connexion RCON testée', noPlayers: 'Aucun joueur connecté', world: 'Monde', unknown: 'inconnu', difficulty: 'Difficulté', whitelist: 'Whitelist', active: 'Active', inactive: 'Inactive', readFromServerProperties: 'Lu depuis server.properties', serverFlavor: 'Serveur', minecraftVersion: 'Version MC', dockerImage: 'Image Docker', updateStatus: 'Mise à jour', panelUpdate: 'Panel', updateAvailable: 'MAJ dispo', upToDate: 'À jour', notChecked: 'Non vérifié',
    quickActions: 'Actions rapides', controlledRcon: 'Actions sécurisées via RCON', saveWorld: 'Sauvegarder', day: 'Mettre le jour', clearWeather: 'Ciel clair', serverMessage: 'Message serveur', send: 'Diffuser', actionDone: 'Action exécutée', error: 'Erreur',
    rconConsole: 'Console RCON', rconConsoleHint: 'Commandes autorisées uniquement', runCommand: 'Exécuter', commandRejected: 'Commande refusée',
    worldRules: 'Règles du monde', rconRead: 'Lecture RCON...', apply: 'Appliquer', backRecommended: 'Réinitialiser valeur par défaut', defaultShort: 'Défaut', ruleApplied: 'règle appliquée', gameruleError: 'Erreur gamerule', themeLight: 'Mode clair', themeDark: 'Mode sombre',
    connected: 'Connectés', nickname: 'Pseudo', add: 'Autoriser', noItem: 'Aucun élément',
    addonsTitle: 'Addons et datapacks', uploadZip: 'Importer ZIP', datapackUnavailable: 'datapack list indisponible', datapackUploaded: 'Datapack envoyé', uploadRejected: 'Upload refusé', catalogTitle: 'Catalogue Modrinth', catalogHint: 'Filtre selon le serveur détecté et la version Minecraft.', catalogSearch: 'Rechercher un datapack, plugin ou mod', allTypes: 'Tous types compatibles', typeDatapack: 'Datapack', typePlugin: 'Plugin', typeMod: 'Mod', typeResourcepack: 'Resource pack', install: 'Installer', installed: 'Installé', incompatible: 'Non installable', downloads: 'téléchargements', openSource: 'Ouvrir la source', noResults: 'Aucun résultat', catalogLoadError: 'Catalogue indisponible', replaceAndInstall: 'Remplacer le fichier existant ?', catalogCompatibleResults: 'résultats compatibles',
    controlledFiles: 'Fichiers contrôlés', mcDataReadOnly: 'Lecture limitée à /mc-data', filter: 'Filtrer', logSource: 'Source logs', live: 'Live', paused: 'Pause', pauseLive: 'Mettre le live en pause', resumeLive: 'Relancer le live', followScroll: 'Défilement auto', tailLines: 'Lignes', lastUpdate: 'MAJ', logUnavailable: 'Logs indisponibles', allLogs: 'Tous',
    serverSettings: 'Paramètres serveur', settingsText: "Runtime cible: Minecraft Java via itzg/minecraft-server. Les actions Docker directes restent hors MVP tant que le socket Docker n'est pas monté.",
    usersRoles: 'Utilisateurs et rôles', usersText: "Les comptes, emails, SMTP et permissions sont gérés par PocketBase. Les collections applicatives sont créées par le script d'initialisation.", openPocketBase: 'Admin PocketBase', pbAdmin: 'PocketBase Admin',
    profileVanilla: 'Vanilla normal', profileFamily: 'Famille / confort', profileEasy: 'Survie facile', profileNormal: 'Survie normale', profileChild: 'Serveur enfant sécurisé'
  },
  en: {
    ...
    worldRules: 'World rules', rconRead: 'Reading RCON...', apply: 'Apply', backRecommended: 'Reset default value', defaultShort: 'Default', ruleApplied: 'rule applied', gameruleError: 'Gamerule error', themeLight: 'Light mode', themeDark: 'Dark mode',
...
const gamerules = {
  fr: {
    keep_inventory: ['Garder l\'inventaire', 'Les joueurs conservent leur inventaire après une mort.'], do_fire_tick: ['Propagation du feu', 'Contrôle la propagation et l\'extinction naturelle du feu.'], mob_griefing: ['Dégâts des mobs', 'Autorise les mobs à modifier le monde, par exemple les creepers.'], players_sleeping_percentage: ['Sommeil requis', 'Pourcentage de joueurs qui doivent dormir pour passer la nuit.'], show_death_messages: ['Messages de mort', 'Affiche les messages de mort dans le chat.'], announce_advancements: ['Annonces de progrès', 'Annonce les progrès obtenus par les joueurs.'], do_immediate_respawn: ['Respawn immédiat', 'Permet le respawn sans écran de mort.'], fall_damage: ['Dégâts de chute', 'Active les dégâts de chute.'], fire_damage: ['Dégâts du feu', 'Active les dégâts de feu.'], drowning_damage: ['Dégâts de noyade', 'Active les dégâts de noyade.'], do_daylight_cycle: ['Cycle jour/nuit', 'Fait avancer le cycle du jour et de la nuit.'], do_weather_cycle: ['Cycle météo', 'Active les changements naturels de météo.'], do_mob_spawning: ['Spawn des mobs', 'Autorise l\'apparition naturelle des mobs.'], do_trader_spawning: ['Marchand ambulant', 'Autorise le spawn du marchand ambulant.'], do_patrol_spawning: ['Patrouilles', 'Autorise le spawn des patrouilles de pillards.'], do_insomnia: ['Insomnie', 'Autorise les phantoms quand les joueurs ne dorment pas.'], random_tick_speed: ['Vitesse ticks aléatoires', 'Contrôle la vitesse de croissance et d\'évolution de certains blocs.'], spawn_radius: ['Rayon du spawn', 'Rayon autour du spawn où les nouveaux joueurs peuvent apparaître.'], max_entity_cramming: ['Cramming entités', 'Nombre maximal d\'entités empilées avant dégâts.'], command_block_output: ['Sortie command blocks', 'Affiche la sortie des blocs de commande.'], send_command_feedback: ['Retour commandes', 'Affiche le retour des commandes exécutées.'], log_admin_commands: ['Log commandes admin', 'Journalise les commandes administrateur.']
  },
  en: {
