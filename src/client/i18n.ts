...
const translations = {
  fr: {
    ...
    worldRules: 'Regles du monde', rconRead: 'Lecture RCON...', apply: 'Appliquer', backRecommended: "Reinitialiser valeur par defaut", defaultShort: "Defaut", ruleApplied: 'regle appliquee', gameruleError: "Erreur gamerule", themeLight: "Mode clair", themeDark: "Mode sombre",
