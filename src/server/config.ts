export const config = {
  ...
  appVersion: process.env.APP_VERSION ?? "1.1.16",
  ...
  catalogUserAgent: process.env.CATALOG_USER_AGENT ?? `MCServer-Panel/${process.env.APP_VERSION ?? "1.1.16"} (https://github.com/DooSys/MCServer-Panel)`
};
